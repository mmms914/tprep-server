...
func (_m *UserRepository) Update(c context.Context, filter interface{}, update interface{}) error {
...
func (_m *UserRepository) UpdateByID(c context.Context, userID string, update interface{}) error {
